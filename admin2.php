	...
	<div class="col-12 mt-5">
        <div class="card">
            <div class="card-header">
                  <div class="row">
                    <div class="col-6">data.json</div>
                    <div class="col text-right">
                        <button class="btn btn-sm btn-outline-success" onclick="openJson('data.json');">Abrir</button>
                        <button class="btn btn-sm btn-outline-success" onclick="saveJson();">Guardar</button></div>
                  </div>
                  
            </div>
            <div class="card-body">
                <textarea placeholder="Texto para editar" name="texto" id="texto" rows="30" style="width: 100%;"><?=$string2?></textarea>
            </div>
	</div>
  </div>
</div>
